            ...
            AssetEvent::Added { id } => {
                ...
                if path == "models/map.glb".into() {
                    ...
                    for gltf_mesh_handle in map.meshes.iter() {
                        ...
                        //for red and blue team
                        for rot in [0., PI] {
                            //spawn copy of the mesh
                            commands.spawn(PbrBundle {
